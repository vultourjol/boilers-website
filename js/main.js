...
const productData = {
    ...
    'Optimus VD23': {
        ...
        availability: 'В наличии',
        specs: {
            'Вид котла': 'Твердотопливный',
            'Тип топлива': 'Дрова, уголь, брикеты',
    ...
    'Zetka PR15': {
        image: 'src/boilers/7.webp',
        price: '₽350,500',
        rating: '4.7',
        description: 'Пеллетный котел с автоматической подачей топлива и интеллектуальной системой управления горением.',
        type: 'Пеллетный котел',
        fuelType: 'pellet',
        power: '28 kW',
        efficiency: '91%',
        ...
        specs: {
            'Вид котла': 'Пеллетный',
            'Тип топлива': 'Древесные пеллеты',
            'Отапливаемая площадь, м²': '700',
            'Установка': 'Напольная',
            'Макс. температура теплоносителя, C': '87±5',
            'Диаметр дымохода, мм': '180',
            'Камера сгорания': 'Закрытая',
            'КПД, %': '91',
            'Макс. давление отопления, бар': '6',
    ...
    'Zetka WD28': {
        image: 'src/boilers/8.webp',
        price: '₽180,900',
        rating: '4.5',
        description: 'Твердотопливный котел длительного горения с эффективной системой дожига газов.',
        type: 'Твердотопливный котел',
        fuelType: 'solid',
        power: '24 kW',
        efficiency: '84%',
        ...
        specs: {
            ...
            'Мощность, кВт': '24',
            'Вид топлива': 'Дрова/Уголь/Брикеты',
            'Кол-во контуров': 'Одноконтурный',
            'Гарантия': '5 лет',
            'Датчик уличной температуры': 'Нет',
            'Время горения одной закладки, час': '12',
            'Вес, кг': '145'
        }
    },
    'Metalhui GX45': {
        image: 'src/boilers/9.webp',
        price: '₽280,650',
        rating: '4.8',
        description: 'Конденсационный газовый котел нового поколения с модулируемой горелкой и высоким КПД.',
        type: 'Газовый конденсационный котел',
        fuelType: 'gas',
        power: '27 kW',
        efficiency: '96%',
        warranty: '8 лет',
    ...
    'Metalhui PL88': {
        image: 'src/boilers/10.webp',
        price: '₽420,999',
        rating: '4.9',
        description: 'Автоматический пеллетный котел с Wi-Fi управлением и системой самоочистки.',
        type: 'Пеллетный котел премиум',
        fuelType: 'pellet',
        power: '35 kW',
        efficiency: '93%',
        warranty: '10 лет',
        availability: 'В наличии',
        specs: {
            'Вид котла': 'Пеллетный автоматический',
            'Тип топлива': 'Древесные пеллеты',
            'Отапливаемая площадь, м²': '1000',
            'Установка': 'Напольная',
            'Макс. температура теплоносителя, C': '90±5',
            'Диаметр дымохода, мм': '220',
            'Камера сгорания': 'Закрытая',
    ...
    'Optimus GT77': {
        image: 'src/boilers/11.webp',
        price: '₽245,300',
        rating: '4.6',
        description: 'Настенный газовый котел с модуляцией мощности и электронным розжигом.',
        type: 'Газовый котел',
        fuelType: 'gas',
        power: '25 kW',
        efficiency: '93%',
        ...
        availability: 'В наличии',
        specs: {
            'Вид котла': 'Газовый настенный',
            'Тип топлива': 'Газ',
            'Отапливаемая площадь, м²': '600',
            'Установка': 'Настенная',
            'Макс. температура теплоносителя, C': '85±3',
            'Диаметр дымохода, мм': '180',
            'Камера сгорания': 'Закрытая',
            'КПД, %': '93',
            'Макс. давление отопления, бар': '6',
            ...
            'Датчик уличной температуры': 'Опция',
            'Комнатный термостат': 'Опция',
            'Модуляция мощности': 'Есть',
            'Вес, кг': '38'
        }
    },
    'Optimus WB19': {
        image: 'src/boilers/12.webp',
        price: '₽155,700',
        rating: '4.3',
        description: 'Комбинированный котел для работы на дровах и угле с большой загрузочной камерой.',
        type: 'Твердотопливный котел',
        fuelType: 'solid',
        power: '20 kW',
        efficiency: '82%',
        ...
        availability: 'В наличии',
        specs: {
            'Вид котла': 'Твердотопливный комбинированный',
            'Тип топлива': 'Дрова, уголь',
            'Отапливаемая площадь, м²': '450',
            'Установка': 'Напольная',
            'Макс. температура теплоносителя, C': '85±5',
