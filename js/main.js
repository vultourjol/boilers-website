...
const productData = {
    ...
    'Zetka FH22': {
        ...
        price: '₽215,400',
        rating: '4.7',
        description: 'Современный газовый котел с функцией модуляции пламени для максимальной эффективности.',
        type: 'Газовый котел',
        fuelType: 'gas',
        power: '24 kW',
        efficiency: '93%',
    ...
    'Zetka QW55': {
        ...
        price: '₽189,900',
        rating: '4.5',
        description: 'Надежный газовый котел с электронной панелью управления и защитой от замерзания.',
        type: 'Газовый котел',
        fuelType: 'gas',
        power: '21 kW',
        efficiency: '91%',
        ...
        specs: {
            'Вид котла': 'Газовый',
            'Тип топлива': 'Газ',
            'Отапливаемая площадь, м²': '420',
            'Установка': 'Настенная',
            'Макс. температура теплоносителя, C': '82±5',
            'Диаметр дымохода, мм': '150',
            'Камера сгорания': 'Открытая',
            'КПД, %': '91',
            'Макс. давление отопления, бар': '5',
    ...
    'Zetka LM33': {
        ...
        price: '₽165,800',
        rating: '4.4',
        description: 'Экономичный твердотопливный котел с системой длительного горения до 10 часов.',
        type: 'Твердотопливный котел',
        fuelType: 'solid',
        power: '19 kW',
        efficiency: '83%',
        ...
        specs: {
            'Вид котла': 'Твердотопливный',
            'Тип топлива': 'Дрова, брикеты',
            'Отапливаемая площадь, м²': '380',
            'Установка': 'Напольная',
            'Макс. температура теплоносителя, C': '85±5',
            'Диаметр дымохода, мм': '180',
            'Камера сгорания': 'Открытая',
            ...
            'Производитель': 'Россия',
            'Мощность, кВт': '19',
            'Вид топлива': 'Дрова/Брикеты',
            'Кол-во контуров': 'Одноконтурный',
            'Гарантия': '4 года',
            'Время горения одной закладки, час': '10',
            'Вес, кг': '115'
        }
    },
    'Zetka NX88': {
        ...
        price: '₽195,600',
        rating: '4.6',
        description: 'Твердотопливный котел повышенной мощности с чугунным теплообменником.',
        type: 'Твердотопливный котел',
        fuelType: 'solid',
        power: '28 kW',
        efficiency: '85%',
    ...
    'Zetka YU44': {
        ...
        price: '₽175,300',
        rating: '4.4',
        description: 'Универсальный твердотопливный котел для работы на различных видах топлива.',
        type: 'Твердотопливный котел',
        fuelType: 'solid',
        power: '22 kW',
        efficiency: '84%',
        ...
        availability: 'В наличии',
        specs: {
            'Вид котла': 'Твердотопливный универсальный',
            'Тип топлива': 'Дрова, уголь, брикеты',
            'Отапливаемая площадь, м²': '500',
            'Установка': 'Напольная',
            'Макс. температура теплоносителя, C': '85±5',
    ...
    'Zetka BV66': {
        ...
        price: '₽325,800',
        rating: '4.8',
        description: 'Пеллетный котел с большим бункером на 250 кг и автоматической подачей топлива.',
        type: 'Пеллетный котел',
        fuelType: 'pellet',
        power: '26 kW',
        efficiency: '92%',
    ...
    'Zetka PO77': {
        ...
        price: '₽368,900',
        rating: '4.7',
        description: 'Автоматический пеллетный котел с Wi-Fi управлением через мобильное приложение.',
        type: 'Пеллетный котел',
        fuelType: 'pellet',
        power: '30 kW',
        efficiency: '93%',
    ...
    'Zetka EK99': {
        ...
        price: '₽295,500',
        rating: '4.6',
        description: 'Пеллетный котел средней мощности с удобной системой очистки от золы.',
        type: 'Пеллетный котел',
        fuelType: 'pellet',
        power: '25 kW',
        efficiency: '90%',
    ...
    'Metalhui DK33': {
        ...
        price: '₽298,700',
        rating: '4.8',
        description: 'Конденсационный газовый котел премиум-класса с минимальным уровнем шума.',
        type: 'Газовый конденсационный котел',
        fuelType: 'gas',
        power: '29 kW',
        efficiency: '97%',
    ...
    'Metalhui RT88': {
        ...
        price: '₽252,400',
        rating: '4.6',
        description: 'Настенный газовый котел с цифровым управлением и защитой от перегрева.',
        type: 'Газовый котел',
        fuelType: 'gas',
        power: '26 kW',
        efficiency: '94%',
    ...
    'Metalhui UY22': {
        ...
        price: '₽229,900',
        rating: '4.5',
        description: 'Классический газовый котел с надежной системой безопасности.',
        type: 'Газовый котел',
        fuelType: 'gas',
        power: '23 kW',
        efficiency: '92%',
    ...
    'Metalhui VF55': {
        ...
        price: '₽185,600',
        rating: '4.4',
        description: 'Твердотопливный котел с увеличенной топочной камерой и системой вторичного дожига.',
        type: 'Твердотопливный котел',
        fuelType: 'solid',
        power: '25 kW',
        efficiency: '86%',
        ...
        specs: {
            ...
            'Кол-во контуров': 'Одноконтурный',
            'Гарантия': '6 лет',
            'Время горения одной закладки, час': '14',
            'Вес, кг': '155'
        }
    },
    'Metalhui HG77': {
        ...
        price: '₽198,800',
        rating: '4.5',
        description: 'Твердотопливный котел длительного горения с водяным контуром.',
        type: 'Твердотопливный котел',
        fuelType: 'solid',
        power: '27 kW',
        efficiency: '87%',
        ...
        availability: 'В наличии',
        specs: {
            'Вид котла': 'Твердотопливный длительного горения',
            'Тип топлива': 'Дрова, уголь',
            'Отапливаемая площадь, м²': '640',
            'Установка': 'Напольная',
            'Макс. температура теплоносителя, C': '90±5',
            'Диаметр дымохода, мм': '200',
            'Камера сгорания': 'Открытая',
            ...
            'Кол-во контуров': 'Двухконтурный',
            'Гарантия': '7 лет',
            'Время горения одной закладки, час': '16',
            'Вес, кг': '170'
        }
    },
    'Metalhui JK44': {
        ...
        price: '₽172,900',
        rating: '4.3',
        description: 'Компактный твердотопливный котел для небольших помещений.',
        type: 'Твердотопливный котел',
        fuelType: 'solid',
        power: '18 kW',
        efficiency: '83%',
        ...
        availability: 'В наличии',
        specs: {
            'Вид котла': 'Твердотопливный компактный',
            'Тип топлива': 'Дрова, брикеты',
            'Отапливаемая площадь, м²': '360',
            'Установка': 'Напольная',
            'Макс. температура теплоносителя, C': '85±5',
            'Диаметр дымохода, мм': '150',
            'Камера сгорания': 'Открытая',
    ...
    'Metalhui WX66': {
        ...
        price: '₽389,500',
        rating: '4.9',
        description: 'Пеллетный котел премиум-класса с полностью автоматизированной работой.',
        type: 'Пеллетный котел премиум',
        fuelType: 'pellet',
        power: '33 kW',
        efficiency: '94%',
        ...
        availability: 'В наличии',
        specs: {
            'Вид котла': 'Пеллетный премиум',
            'Тип топлива': 'Древесные пеллеты',
            'Отапливаемая площадь, м²': '950',
            'Установка': 'Напольная',
            'Макс. температура теплоносителя, C': '92±5',
            'Диаметр дымохода, мм': '220',
            'Камера сгорания': 'Закрытая',
    ...
    'Metalhui ZA99': {
        ...
        price: '₽335,700',
        rating: '4.7',
        description: 'Пеллетный котел с электронной системой управления и погодозависимой автоматикой.',
        type: 'Пеллетный котел',
        fuelType: 'pellet',
        power: '28 kW',
        efficiency: '92%',
    ...
    'Optimus LK55': {
        ...
        price: '₽268,300',
        rating: '4.7',
        description: 'Газовый конденсационный котел с интеллектуальной системой управления.',
        type: 'Газовый конденсационный котел',
        fuelType: 'gas',
        power: '28 kW',
        efficiency: '95%',
    ...
    'Optimus MN22': {
        ...
        price: '₽212,600',
        rating: '4.5',
        description: 'Компактный газовый котел с эффективной системой отопления.',
        type: 'Газовый котел',
        fuelType: 'gas',
        power: '20 kW',
        efficiency: '91%',
        ...
        specs: {
            'Вид котла': 'Газовый настенный',
            'Тип топлива': 'Газ',
            'Отапливаемая площадь, м²': '400',
            'Установка': 'Настенная',
            'Макс. температура теплоносителя, C': '82±3',
            'Диаметр дымохода, мм': '150',
            'Камера сгорания': 'Открытая',
            'КПД, %': '91',
            'Макс. давление отопления, бар': '5',
    ...
    'Optimus PO88': {
        ...
        price: '₽239,800',
        rating: '4.6',
        description: 'Газовый котел с функцией модуляции и встроенным расширительным баком.',
        type: 'Газовый системный котел',
        fuelType: 'gas',
        power: '30 kW',
        efficiency: '93%',
    ...
    'Optimus QR33': {
        ...
        price: '₽168,400',
        rating: '4.3',
        description: 'Твердотопливный котел классической конструкции с надежной работой.',
        type: 'Твердотопливный котел',
        fuelType: 'solid',
        power: '21 kW',
        efficiency: '81%',
        ...
        availability: 'В наличии',
        specs: {
            'Вид котла': 'Твердотопливный классический',
            'Тип топлива': 'Дрова, уголь',
            'Отапливаемая площадь, м²': '480',
            'Установка': 'Напольная',
            'Макс. температура теплоносителя, C': '85±5',
            'Диаметр дымохода, мм': '180',
            'Камера сгорания': 'Открытая',
    ...
    'Optimus TY66': {
        ...
        price: '₽182,700',
        rating: '4.5',
        description: 'Твердотопливный котел с системой регулирования тяги и защитой от перегрева.',
        type: 'Твердотопливный котел',
        fuelType: 'solid',
        power: '24 kW',
        efficiency: '84%',
        ...
        specs: {
            ...
            'Кол-во контуров': 'Одноконтурный',
            'Гарантия': '5 лет',
            'Время горения одной закладки, час': '11',
            'Вес, кг': '142'
        }
    },
    'Optimus UI77': {
        ...
        price: '₽315,900',
        rating: '4.8',
        description: 'Пеллетный котел с большой загрузочной емкостью и автоматической очисткой.',
        type: 'Пеллетный котел',
        fuelType: 'pellet',
        power: '27 kW',
        efficiency: '91%',
    ...
    'Optimus AS44': {
        ...
        price: '₽358,600',
        rating: '4.7',
        description: 'Автоматический пеллетный котел с цифровым дисплеем и удаленным управлением.',
        type: 'Пеллетный котел',
        fuelType: 'pellet',
        power: '31 kW',
        efficiency: '92%',
    ...
    'Optimus DF99': {
        ...
        price: '₽289,200',
        rating: '4.6',
        description: 'Пеллетный котел средней мощности с экономичным расходом топлива.',
        type: 'Пеллетный котел',
        fuelType: 'pellet',
        power: '24 kW',
        efficiency: '90%',
